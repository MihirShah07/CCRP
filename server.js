...
const complaint = require('./model/add_comp'); // Corrected import name
...
app.post('/api/addComplaint', async (req, res) => {
    ...
    try {
        ...
        const response = await complaint.create({
            ...
            "complainer_details.date_of_complainer_visit": complainerVisitDateTimeInput,
            ...
            "complainer_details.complainer_alternative_email_address": complainerAltEmailInput,
